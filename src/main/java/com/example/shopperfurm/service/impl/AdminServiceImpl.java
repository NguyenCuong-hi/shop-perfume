package com.example.shopperfurm.service.impl;

import com.example.shopperfurm.constants.ErrorMessage;
import com.example.shopperfurm.constants.SuccessMessage;
...
import com.example.shopperfurm.repository.OrderRepository;
import com.example.shopperfurm.repository.PerfumeRepository;
import com.example.shopperfurm.repository.UserRepository;
import com.example.shopperfurm.service.AdminService;
...
public class AdminServiceImpl implements AdminService {
    ...
    public Order getOrder(Long orderId) {
        return orderRepository.findById(orderId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, ErrorMessage.ORDER_NOT_FOUND));
    }
